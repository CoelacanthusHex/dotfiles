...
: ${ZSH_DOTENV_ALLOWED_LIST:="${ZSH_CACHE_DIR:-$XDG_CACHE_HOME}/dotenv-allowed.list"}
: ${ZSH_DOTENV_DISALLOWED_LIST:="${ZSH_CACHE_DIR:-$XDG_CACHE_HOME}/dotenv-disallowed.list"}
